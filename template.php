...
<head>
    ...
    <title>Laporan Transaksi Tresna</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                    <!-- Logo -->
                    <a class="logo" href="template.php">
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="template.php" class="waves-effect"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="template.php?content=profile.php" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Profil</a>
                    </li>
                    <li>
                        <a href="template.php?content=rekap.php" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>Rekapitulasi Penjualan</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                ?>
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2020 &copy; Ample Admin Modification by @andifauzy7</footer>
        </div>
        <!-- ============================================================== -->
        <!-- End Page Content -->
        <!-- ============================================================== -->
